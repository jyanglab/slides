---
title: "Selection-drift and Diversity"
...
\begin{align*}
Pr(fixation) = \frac{1 - e^{-2s}}{1- e^{-4N_es}} \approx \frac{2s}{4N_es} = \frac{1}{2N_e}
\end{align*}
...
\begin{align*}
Pr(fixation) = \frac{1 - e^{-2s}}{1- e^{-4N_es}} \approx \frac{1}{2N_e}
\end{align*}
...
- Favorable mutations likely be lost (and deleterious mutations can be fixed)
  - __Genetic costs of domestication__: the increase of the deleterious mutational load of domesticated species
...
# The genetic load in elite maize

<div align="center">
<img src="pgen.png" width=400>
</div>

- Using __GERP (genomic evolutionary rate profiling)__ to measure deleteriousness

> [Yang et al., 2017](https://journals.plos.org/plosgenetics/article?id=10.1371/journal.pgen.1007019)
...
# A human genetic study

<div align="center">
<img src="load.png" width=400>
</div>

> [Simons et al., 2014](https://www.nature.com/articles/ng.2896)
...
\begin{align*}
F_t = \frac{1}{2N_e} + (1 - \frac{1}{2N_e})F_{t-1}
\end{align*}
...
\begin{align*}
F_t = [\frac{1}{2N_e} + (1 - \frac{1}{2N_e})F_{t-1}] (1 - \mu )^2
\end{align*}
...
- The relationship between $N_e$, $\mu$, and $F$ at equilibrium.
...
\begin{align*}
H_{exp} = 1 - \frac{1}{m}\sum_{l=1}^{m} \sum_{i=1}^{k} p_{ki}^2
\end{align*}

  - $l$ is the number of loci (1 to $m$)
  - $i$ is the number of alleles at a particular locus (1 to $k$)
  - $p_{li}$ is the frq of $i^{th}$ allele at $l^{th}$ locus
