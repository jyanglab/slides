...
\begin{align*}
E(XY) & = \sum_i \sum_j x_i y_j Pr(X = x_i, Y = y_j) \\
E(AD) &= (2q\alpha)\times (-2q^2d) \times p^2  +  (q-p)\alpha \times 2pqd \times 2pq  +  (-2p\alpha) \times (-2p^2d) \times q^2 \\
...
- Measurement error, developmental accidents, temporary climatic effects, etc.
...
| Data                            | Partition      | Ratio | Definition |
| :-----------------------------  | :-------: | :-----------: | :---: |
