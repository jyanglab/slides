...
---
# Covariance due to additive genetic covariance
...
Recall that the __coefficient of co-ancestry ( $f_{XY}$ from Ch.5)__ between a non-inbred parent and non-inbred offspring is 1/4. Thus, the coefficient for $\sigma_A^2$ is 1/2.

Consider the convariance between parent (P) and offspring (O), if we assume the two alleles of the parent are unrelated, then all offspring can't share a common dominance deviation ( $\sigma^2_D$ =0 ). Therefore,
