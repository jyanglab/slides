...
- In next generation, process repeats itself, but variance differs from line to line because each has a different starting freq
...
- Eventually, each line will become fixed
  - Proportion of lines fixed for each allele can be estimated by $p_0$ and $q_0$
...
- For the population as a whole, this leads to increased homozygosity
